...
export const projects: Project[] = [
  ...
  // Slot: hero (large, 2/3 width) and banner (full-width) — in that order
  {
    ...
    accentColor: "#D7D7D7",
    description: "From quiet residencies to soul-stirring gatherings, a seasonal film for workshops, retreats, and community events.",
  ...
  },
  {
    ...
    accentColor: "#D7D7D7",
    description: "A promotional marketing reel crafted entirely using stock footage.",
    youtubeId: "bkIVe0NLKS8",
    tags: ["Reel", "Stock Footage", "Marketing"],
  },
  {
    id: 12,
    title: "Naturaltein Relaunch",
    client: "Naturaltein",
  ...
  {
    id: 13,
    title: "Indian Raga x Aim for Seva",
    client: "Indian Raga",
    ...
    accentColor: "#D7D7D7",
    description: "Editing for the launch trailer of the Indian Raga and Aim for Seva collaboration.",
